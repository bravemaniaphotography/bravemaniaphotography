...
// ===== PORTFOLIO =====
// ALL 30 PHOTOS - Note: Lifestyle has capital 'L', rest are lowercase
const portfolioData = [
    // PORTRAIT - 7 photos (all lowercase .jpg)
    {
        category: 'portrait',
    ...
    },
    {
        ...
        description: 'Clean sophistication',
        image: 'images/portrait-06.jpg'
    },
    {
        category: 'portrait',
        title: 'Natural Light',
        description: 'Sun-kissed beauty',
        image: 'images/portrait-07.jpg'
    },
    
    // BOUDOIR - 11 photos (all lowercase .jpg)
    {
        category: 'boudoir',
    ...
    // LIFESTYLE - 12 photos (Capital 'L', mixed .jpg and .JPG)
    {
        category: 'lifestyle',
...
function renderPortfolio(filter = 'all') {
    ...
    filteredData.forEach(item => {
        ...
        portfolioItem.innerHTML = `
            <img src="${item.image}" alt="${item.title}" loading="lazy" onerror="this.style.display='none'; console.error('Failed to load: ${item.image}');">
